...
const demoAccounts = [
  { label: 'Akaash', email: 'admin@company.com', password: 'Admin123!', role: 'admin', initials: 'AK', color: '#f87171' },
  { label: 'Bhuvana', email: 'finance@company.com', password: 'Finance123!', role: 'finance', initials: 'BH', color: '#34d399' },
  { label: 'Varshitha', email: 'manager@company.com', password: 'Manager123!', role: 'manager', initials: 'VA', color: '#7c5cfc' },
  { label: 'Srija', email: 'john@company.com', password: 'Employee123!', role: 'employee', initials: 'SR', color: '#38bdf8' },
];
